      ...
      <main className="p-5 space-y-6">
        ...
        <div className="bg-card rounded-3xl p-5 shadow-[var(--shadow-card)] border border-border">
           <div className="flex justify-between items-center mb-4">
             <h3 className="font-semibold text-muted-foreground text-sm uppercase tracking-wide">Delivery Address</h3>
        ...
        {/* Order Summary */}
        <div className="bg-card rounded-3xl p-5 shadow-[var(--shadow-card)] border border-border">
           <h3 className="font-semibold text-muted-foreground text-sm uppercase tracking-wide mb-4">Order Summary</h3>
           ...
           <div className="space-y-4">
             <div>
               <div className="flex justify-between items-start mb-1">
                 ...
                 {insuranceType === "gkv" ? (
                   <span className="text-sm font-semibold text-muted-foreground line-through">€24.95</span>
                 ) : (
                   <span className="text-sm font-semibold text-foreground">€24.95</span>
                 )}
               </div>
             ...
             <div className="flex justify-between items-center">
                {insuranceType === "gkv" ? (
                  <>
                    ...
                    <span className="text-sm text-emerald-600 font-semibold">-€2.50</span>
                  </>
                ) : (
                  <div className="w-full">
                     <div className="flex justify-between items-center mb-1">
                       <span className="text-sm text-primary font-medium">Privatrezept-Bonus</span>
                       <span className="text-sm text-primary font-semibold">€2.50 credit</span>
                     </div>
                     <p className="text-xs text-muted-foreground">You'll receive €2.50 account credit for future orders</p>
                  </div>
                )}
             </div>
