...
export default function TelehealthReview() {
  ...
  return (
    <div className="min-h-screen bg-background pb-28">
      ...
      <main className="p-5">
        <div className="bg-card rounded-3xl shadow-[var(--shadow-card)] border border-border overflow-hidden mb-6">
          ...
          <div className="p-4 flex items-start gap-4">
            ...
            <div className="flex-1 pt-0.5">
              <p className="font-semibold text-foreground text-sm">Video Consultation</p>
          ...
          <div className="p-4 flex items-start gap-4">
             ...
             <div className="flex-1 pt-0.5">
               <p className="font-semibold text-foreground text-sm mb-1">Your Symptoms</p>
          ...
          <div className="p-4 flex items-start gap-4">
             ...
             <div className="flex-1 pt-0.5">
               <p className="font-semibold text-foreground text-sm">Cost</p>
               <span className="text-xs font-semibold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded inline-block mt-1">
        ...
        <div className="flex items-start gap-3 p-2">
           ...
           <div className="grid gap-1.5 leading-none">
             <label
               htmlFor="consent"
               className="text-sm font-medium leading-normal peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-foreground"
             >
