    ...
    <div className="min-h-screen bg-background pb-32">
      ...
      <main className="p-5 space-y-8">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between bg-blue-50 text-[#0C3D91] p-3 rounded-2xl border border-blue-100">
             <div className="flex items-center gap-3">
               ...
               <span className="font-bold">Gesetzliche Versicherung (GKV)</span>
             </div>
        ...
        <div className="space-y-3">
          <Label className="text-sm font-medium text-slate-700">Krankenkasse</Label>
        ...
        <div className="space-y-4">
           <div className="space-y-3">
              <Label className="text-sm font-medium text-slate-700">Versichertennummer</Label>
              <Input 
                defaultValue="A123456789"
                className="h-12 rounded-xl bg-white border-slate-200"
              />
              <p className="text-xs text-slate-400">10 Zeichen: Buchstabe + 9 Ziffern</p>
           </div>
           
           <Button variant="outline" className="w-full h-12 rounded-xl border-primary text-primary hover:bg-blue-50 gap-2">
             <Camera size={18} />
             Gesundheitskarte neu scannen
           </Button>
        </div>
      </main>
